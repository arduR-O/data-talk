...
class State(TypedDict, total=False):
    ...
    result: str
    answer: str
    conversation_history: List[BaseMessage]  # Use List instead of list for better type compatibility
...
def chat(question: str, conversation_history: List[BaseMessage] = None, db_url: str = None) -> str:
    """
    ...
    # Create initial state - convert list to tuple or ensure it's properly typed
    initial_state = {
        "question": question,
    ...
    # Note: The ChatController will handle adding messages to conversation_history
    # We don't modify it here to avoid duplication
