        ...
        >
          ...
          >
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 bg-white/5 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-4 rounded-xl font-semibold shadow-lg hover:from-blue-500 hover:to-purple-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900"
            >
              Sign in
            </motion.button>
          </motion.form>
          ...
          >
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="button"
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-600 rounded-xl shadow-sm text-sm font-medium text-gray-300 bg-white/5 hover:bg-white/10 transition-all duration-300"
              >
