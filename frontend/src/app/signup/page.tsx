...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    const initializeGSI = () => {
      ...
      // Initialize GSI flow using Google's SDK popup dialog helper
      ...
      // Render button in container so it safely triggers the Google Identity Services modal
    ...
    // Auto-inject GSI script if not present
    if (!window.google) {
