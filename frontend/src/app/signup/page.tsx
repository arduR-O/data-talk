          ...
          >
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <motion.button
                ...
                type="button"
                disabled={loading}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-600 rounded-xl shadow-sm text-xs font-medium text-gray-300 bg-white/5 hover:bg-white/10 transition-all duration-300 disabled:opacity-50"
              >
